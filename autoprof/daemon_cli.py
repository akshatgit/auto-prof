...
from .collaboration import (
    ...
    execute_collaboration_scan_job,
...
from .defense import (
    execute_defense_review_job,
    execute_propose_lab_job,
    execute_student_write_defense_job,
)
...
SPECIAL_HANDLERS = {
    ...
    "student_write_defense": execute_student_write_defense_job,
    "defense_review": execute_defense_review_job,
    "propose_lab": execute_propose_lab_job,
